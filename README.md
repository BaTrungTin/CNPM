...
#### Hành vi sử dụng:
- A thường xuyên truy cập vào ứng dụng để đặt hàng, theo dõi đơn hàng và phản hồi về dịch vụ. Anh cũng hay đọc phản hồi từ những khách hàng trước đó để đánh giá dịch vụ.

#### Thiết bị sử dụng:
- Laptop và smartphone.
...
#### Hành vi sử dụng:
- B thường xuyên phải theo dõi và xử lý các đơn hàng mới. Cô cần liên hệ với khách hàng để xác nhận thông tin đơn hàng.
...
#### Hành vi sử dụng:
- C thường phải cập nhật thông báo về các đơn hàng mới cần giao và tình trạng vận chuyển cũng như báo cáo về sức khỏe cá.
...
#### Hành vi sử dụng:
- D thường phải kiểm tra báo cáo hiệu suất hàng tháng và điều chỉnh bảng giá cũng như chính sách dịch vụ (nếu cần).
